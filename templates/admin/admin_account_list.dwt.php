...
<div class="row-fluid batch">
	<ul class="nav nav-pills">
		<li class="{if !$filter.type}active{/if}">
			<a class="data-pjax" href='{url path="finance/admin_account/init" args="
		...
		<li class="{if $filter.type eq 'finished'}active{/if}">
			<a class="data-pjax" href='{url path="finance/admin_account/init" args="type=finished
				{if $filter.payment}&payment={$filter.payment}{/if}
				{if $filter.start_date}&start_date={$filter.start_date}{/if}
				{if $filter.end_date}&end_date={$filter.end_date}{/if}
				{if $filter.keywords}&keywords={$filter.keywords}{/if}
		...
		<li class="{if $filter.type eq 'canceled'}active{/if}">
			<a class="data-pjax" href='{url path="finance/admin_account/init" args="type=canceled
				{if $filter.payment}&payment={$filter.payment}{/if}
				{if $filter.start_date}&start_date={$filter.start_date}{/if}
				{if $filter.end_date}&end_date={$filter.end_date}{/if}
				{if $filter.keywords}&keywords={$filter.keywords}{/if}
		...
		<table class="table table-striped" id="smpl_tbl">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">
						<a class="data-pjax no-underline" href='{url path="finance/admin_account/info" args="id={$item.id}{if $type}&type={$type}{/if}"}'
