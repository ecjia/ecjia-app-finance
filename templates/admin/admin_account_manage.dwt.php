            ...
            <div class="manage_box">
                <div class="ov_group">
                    ...
                    <div class="ov_text">
                        ...
                        <a href='{url path="finance/admin_account/init" args="process_type=0&is_paid=1&start_date={$start_date}&end_date={$end_date}"}'>
                ...
                <div class="ov_group">
                    ...
                    <div class="ov_text">
                        ...
                        <a href='{url path="finance/admin_account/init" args="process_type=1&is_paid=1&start_date={$start_date}&end_date={$end_date}"}'>
            ...
            <div class="manage_box">
                <div class="ov_group">
                    ...
                    <div class="ov_text">
                        ...
                        <a href='{url path="finance/admin_account_manage/surplus" args="start_date={$start_date}&end_date={$end_date}"}'>
