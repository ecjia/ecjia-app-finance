...
class finance_admin_menu_api extends Component_Event_Api {
    ...
    public function call(&$options) {
        ...
        $submenus = array(
        	...
        	ecjia_admin::make_admin_menu('02_account', '充值和提现申请', RC_Uri::url('finance/admin_account/init'), 2)->add_purview('surplus_manage'),
        	ecjia_admin::make_admin_menu('03_invoice', '发票列表', RC_Uri::url('finance/appeal/init'), 3)->add_purview('invoice_manage'),
        );
