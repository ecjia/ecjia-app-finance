...
class admin_config extends ecjia_admin
{
    ...
    public function init()
    {
        ...
        $this->assign('form_action', RC_Uri::url('finance/admin_config/update'));
    ...
    public function update()
    {
        ...
        return $this->showmessage('保存成功', ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('finance/admin_config/init')));
    }
